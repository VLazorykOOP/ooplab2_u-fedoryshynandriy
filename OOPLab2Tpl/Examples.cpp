...
/*
Задано текст до 64 символів. Доповнити пробілами до 64 символів. Шифрувати тексти таким чином, щоб кожний символ тексту записувався у два байта.
Два байта мають таку структуру:
...
15 біт – біт парності коду символу (1 біт)
	  ...
	  |Бп|   Код букви             |БП|Позиція символу  |
*/
...
void MyEncryption(char InS[64], unsigned short OutCoding[64])
{
    ...
    for (i = 0; i < 64; i++)            //
	{
		...
		t = c;
		r |= t >> 4;                  // 0000 0000 0000 0111                                    //старша частина
		r |= i << 4;                  // 0000 0000 0101 0111  if i=5 -> 0000 0000 0000 0101   //позиція
		t = c;
		r |= t << 12;                 // 0011 0000 0101 0111  if i=5 0000 0000 0000 0101          //молодша частина
		t = 1;
		b = 0;
		...
		r |= b << 11;                    // 0011 0000 0101 0111 if i=5 0000 0000 0000 0101               //біт парності
		OutCoding[i] = r;
	}
}
struct TextCode {
